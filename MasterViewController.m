...
//**OLIVER NOTE** Object context is the memory where we store our objects **OLIVER NOTE**

- (void)insertNewObject:(id)sender {
    NSManagedObjectContext *context = [self.fetchedResultsController managedObjectContext];
    
    //**OLIVER NOTE** Entity is the description of the object we created, in this case DueDate or ToDo **OLIVER NOTE**
